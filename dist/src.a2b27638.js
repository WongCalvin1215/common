...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/functions/common.js":[function(require,module,exports) {
"use strict";
...
var Common = /*#__PURE__*/function () {
  ...
  _createClass(Common, [{
    ...
    value: function format() {
      return _config.lang === "chn" ? "".concat(this.days, "\u65E5").concat(this.hours, "\u5C0F\u6642").concat(this.minutes, "\u5206") : "".concat(this.days, "-").concat(this.hours, "-").concat(this.minutes);
    }
  }, {
    key: "sleep",
...
},{}],"src/function_chaining.js":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _common = _interopRequireDefault(require("./functions/common"));
...
var example = function example() {
  var c = new _common.default();
  console.log(c.format());
  var c2 = new _common.default(1, 1, 1).add(2).subtract(1);
  // // equals to this
  // // let c2 = Common(1, 1, 1);
  // // c2.add(2);
  // // c2.subtract(1);
...
},{"./functions/common":"src/functions/common.js"}],"src/resolve_all.js":[function(require,module,exports) {
"use strict";
...
var get_config = /*#__PURE__*/function () {
  ...
  return function get_config() {
    return _ref2.apply(this, arguments);
  };
}();
var get_shop = /*#__PURE__*/function () {
...
var example = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var _result$1$data;
    var arr, result, shops, is_show_shop, _result$0$data, userId, get_shop_result;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          arr = [get_user, get_config];
          _context4.next = 3;
          return c.resolve_all(arr);
        case 3:
          result = _context4.sent;
          console.log(result);
          shops = [];
          is_show_shop = false;
          is_show_shop = result[1].status === "Success" && c.is_boolean((_result$1$data = result[1].data) === null || _result$1$data === void 0 ? void 0 : _result$1$data.is_show_shop);
          if (!is_show_shop) {
            _context4.next = 14;
            break;
          }
          userId = result[0].status = "Success" && ((_result$0$data = result[0].data) === null || _result$0$data === void 0 ? void 0 : _result$0$data.id);
          _context4.next = 12;
          return get_shop(userId);
        case 12:
          get_shop_result = _context4.sent;
          if (get_shop_result.status === "Success") {
            shops = get_shop_result.data;
          }
        case 14:
          console.log("shops: ".concat(shops));
        case 15:
        case "end":
...
var _default = example;
exports.default = _default;
},{"./functions/common":"src/functions/common.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

var _function_chaining = _interopRequireDefault(require("./function_chaining"));
var _resolve_all = _interopRequireDefault(require("./resolve_all.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
(0, _function_chaining.default)();
//resolve_all();
},{"./function_chaining":"src/function_chaining.js","./resolve_all.js":"src/resolve_all.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
